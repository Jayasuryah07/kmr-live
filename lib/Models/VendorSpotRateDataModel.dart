...
//
//     final vendorSpotRateDataModel = vendorSpotRateDataModelFromJson(jsonString);

import 'dart:convert';

VendorSpotRateDataModel vendorSpotRateDataModelFromJson(String str) => VendorSpotRateDataModel.fromJson(json.decode(str));
