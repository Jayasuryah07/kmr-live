                                          ...
                                          if (value['code'] == 200) {
                                            ...
                                            await FirebaseAuth.instance
                                              ...
                                              verificationCompleted:
                                                ...
                                                debugPrint(
                                                    'verificationId: ${credential.verificationId}~~${credential.smsCode}');
                                                debugPrint(
                                                    'smsCode: ${credential.smsCode}~~${credential.token}');
                                                debugPrint(
                                                    'accessToken: ${credential.accessToken}~~${credential.providerId}');
                                                debugPrint(
