...
import '../news_screen/news_data_page.dart';
              ...
              return Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: ConstHelper.cementColor.withAlpha(230),
                        blurRadius: 1,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(homeController.allNewsDataList[index].newsContent == null || homeController.allNewsDataList[index].newsContent!.trim().isEmpty ? 'Details N/A' : homeController.allNewsDataList[index].newsContent!,
                                          style: TextStyle(color: ConstHelper.blackColor.withAlpha(230),
                                            overflow: TextOverflow.ellipsis,
