...
import 'package:kmr/Screens/NewsScreen/NewsDataPage.dart';
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(homeController.searchedNewsDataList[index].newsHeadlines == null || homeController.searchedNewsDataList[index].newsHeadlines!.trim().isEmpty ? 'Headline N/A' : homeController.searchedNewsDataList[index].newsHeadlines!,style: TextStyle(color: ConstHelper.blackColor,fontWeight: FontWeight.w600,fontSize: 15,),),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(homeController.allNewsDataList[index].newsHeadlines == null || homeController.allNewsDataList[index].newsHeadlines!.trim().isEmpty ? 'Headline N/A' : homeController.allNewsDataList[index].newsHeadlines!,style: TextStyle(color: ConstHelper.blackColor,fontWeight: FontWeight.w600,fontSize: 15,),),
