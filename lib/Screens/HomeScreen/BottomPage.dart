            ...
            title: Obx(
                  ...
                  ? Padding(
                    ...
                    color: ConstHelper.whiteColor,
                                    ...
                                    onChanged: (value) {
                    homeController.searchStart.value = value.trim().isNotEmpty;
                      ...
                      if (homeController.selectedIndex.value == 0) {
                        homeController.searchedLiveDataList.value =
                            homeController.allLiveDataList.where(
                                  (p0) {
                                String date =
                                p0.vendorProductCreatedDate == null ||
            ...
            actions: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  homeController.searchClick.value = !homeController.searchClick.value;
                },
                icon: Obx(
                      () => Icon(
                    homeController.searchClick.value
            ...
            bottom: PreferredSize(
                ...
                child: DefaultTabController(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      for(int i=0; i<homeController.allSubCategoryDataList.length;i++)
                        Tab(
                          text: "${homeController.allSubCategoryDataList[i].categorySubName}",
                        ),
                    ],
                    onTap: (value) {
                ...
                onChanged: (value) {
                  ...
                  if (value.trim().isNotEmpty) {
                    ...
                    if (homeController.selectedIndex.value == 2) {
                      homeController.searchedSpotRateDataList.value =
                          homeController.allSpotRateDataList.where(
                                (p0) {
                              String date =
                              p0.vendorSpotCreatedDate == null ||
